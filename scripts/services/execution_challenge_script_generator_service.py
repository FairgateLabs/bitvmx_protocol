...
class ExecutionChallengeScriptGeneratorService:
    ...
    def __call__(
        ...
        script.extend([0, "OP_NUMEQUALVERIFY"])
        script.extend([0, "OP_NUMEQUALVERIFY"])
        script.extend([1, "OP_NUMEQUALVERIFY"])
        script.extend([7, "OP_NUMEQUALVERIFY"])
        script.extend([8, "OP_NUMEQUALVERIFY"])
        script.extend([7, "OP_NUMEQUALVERIFY"])
        script.extend([9, "OP_NUMEQUALVERIFY"])
        script.extend([3, "OP_NUMEQUALVERIFY"])
        for _ in range(total_length - 8):
            script.append("OP_DROP")
