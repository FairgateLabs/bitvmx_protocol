...
from winternitz_keys_handling.functions.signature_functions import hex_ripemd160, hex_hash160
...
class GenerateWinternitzKeysSingleWordService:
    ...
    def __call__(self, step: int, case: int, amount_of_bits: int):
        ...
        d1, _, _ = self.compute_max_checksum_service(
