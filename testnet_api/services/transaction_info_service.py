...
class TransactionInfoService:
    ...
    def __call__(self, tx_id: str) -> TransactionInfo:
        url = f"https://mempool.space/testnet/tx/{tx_id}"
        ...
        headers = {
            ...
            'cookie': '_pk_ref.5.9dfc=%5B%22%22%2C%22%22%2C1721812939%2C%22https%3A%2F%2Fwww.google.com%2F%22%5D; _pk_id.5.9dfc=8da1a72131301656.1721812939.; _pk_ses.5.9dfc=1',
            'priority': 'u=0, i',
