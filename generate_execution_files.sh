...
cargo run --manifest-path ./BitVMX-CPU-Internal/Cargo.toml -p emulator -- execute --elf ./BitVMX-CPU-Internal/docker-riscv32/plainc.elf --input 01 -t > ./verifier_files/execution_trace.txt
cargo run --manifest-path ./BitVMX-CPU-Internal/Cargo.toml -p emulator -- execute --elf ./BitVMX-CPU-Internal/docker-riscv32/plainc.elf --input 01 -t > ./prover_files/execution_trace.txt