...
async def public_keys(public_keys_body: PublicKeysBody) -> PublicKeysResponse:
    ...
    protocol_dict["amount_of_wrong_step_search_iterations"] = public_keys_body.amount_of_wrong_step_search_iterations
    protocol_dict["amount_of_bits_wrong_step_search"] = public_keys_body.amount_of_bits_wrong_step_search
    ...
    protocol_dict["choice_search_verifier_public_keys_list"] = choice_search_verifier_public_keys_list
